...
class Top1Gate(torch.nn.Module):
    ...
    def forward(self, input: torch.Tensor, mask: Optional[torch.Tensor] = None, has_tutel=False, logits:torch.Tensor=None,) -> Tuple[Tensor, Tensor, Tensor, Dict]:  # type: ignore
        if logits is None:
